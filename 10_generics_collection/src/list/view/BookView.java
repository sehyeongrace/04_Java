...
public class BookView {
	...
	public void displayMenu() {
		...
		do{
			...
			case 4: modifyBookPrice222(); break;
...
//		if( list.size() == 0 ) {
	...
	/* 다른 풀이 방법 */
	private void modifyBookPrice222() {
		System.out.println("\n### 책 가격 수정하기 ###\n");
		...
		// 서비스호출
		System.out.println(service.modifyBookPrice222(index, newPrice));
	}
	...
	private void removeBookTitle() {
		System.out.println("제거할 책 제목 입력 : ");
		String title = sc.nextLine();
		
		BookDTO book = service.removeBookTitle(title);
		System.out.println(title + " 이/가 지워짐");
	}

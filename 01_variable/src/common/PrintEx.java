...
public class PrintEx {
	...
	public static void main(String[] args) {
		 ...
		 *   (ln == line) 
		 * 
		 * 3) System.out.printf("문장열 템플릿(패턴)", 패턴에 대입될 값/변수...);
		 * 
		...
		// print() 확인
		System.out.println("이름 : "); // 줄바꿈(개행) X
		System.out.println("홍길동"); // 줄바꿈(개행) X
		System.out.println(", 나이 : 20세"); // 줄바꿈(개행) X
		// -> 출력 결과 : 이름 : 홍길동, 나이 : 20세
		...
		// printf() 버전
		System.out.println("%s는 %d세 %c아로 키는 %.1fcm 이며, 자바 공부 여부: %b"
